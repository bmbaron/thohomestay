function toggleMobileMenu() {
        ...
        document.getElementsByClassName('mobile-bar')[0].classList.toggle('active');
} 
...
leftReview.alt = "reviewer Jordane G.";
...
centerReview.alt = "reviewer Trinh S.";
...
rightReview.alt = "reviewer Loretta I.";
...
window.onload = function() {
    var elements = document.querySelectorAll( '.examples' );
    Intense( elements );
}
